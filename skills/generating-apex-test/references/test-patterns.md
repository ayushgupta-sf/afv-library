...
- Test `execute` with full and partial batches
- Test `finish` for cleanup, chaining, or notifications
- See [async-testing.md](async-testing.md) for `Test.stopTest()` patterns
